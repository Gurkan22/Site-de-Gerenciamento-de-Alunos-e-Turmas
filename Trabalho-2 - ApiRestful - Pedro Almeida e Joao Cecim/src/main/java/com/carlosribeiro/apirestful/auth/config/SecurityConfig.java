package com.carlosribeiro.apirestful.auth.config;

import com.carlosribeiro.apirestful.auth.filter.JwtAuthenticationFilter;
import com.carlosribeiro.apirestful.auth.service.UsuarioDetailsService;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/autenticacao/usuarios/admin").hasRole(Role.ADMIN.name())
                        .requestMatchers(HttpMethod.POST, "/autenticacao/**").permitAll()

                        // Alunos: GET -> precisa ROLE_USER ou ROLE_ADMIN
                        ...
                        // Turmas: mesma regra que Alunos
                        .requestMatchers(HttpMethod.GET, "/turmas/**").hasAnyRole(Role.USER.name(), Role.ADMIN.name())
                        ...
                        // Inscrições: POST e DELETE apenas para ADMIN
                        .requestMatchers(HttpMethod.POST, "/inscricoes/**").hasRole(Role.ADMIN.name())
