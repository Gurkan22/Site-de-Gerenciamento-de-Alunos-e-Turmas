...
const produtos: Produto[] = [
    {
      ...
      disponivel: true,
      dataCadastro: new Date(2024, 4, 26),
      qtdEstoque: 100,
      preco: 2.45,
    },
    {
      ...
      disponivel: false,
      dataCadastro: new Date(2024, 5, 22),
      qtdEstoque: 500,
      preco: 1.1,
    },
    {
      ...
      disponivel: true,
      dataCadastro: new Date(2024, 3, 24),
      qtdEstoque: 400,
      preco: 4.7,
    },
    {
      ...
      disponivel: true,
      dataCadastro: new Date(2024, 3, 12),
      qtdEstoque: 120,
      preco: 4.99,
    },
    {
      ...
      disponivel: true,
      dataCadastro: new Date(2024, 5, 17),
      qtdEstoque: 340,
      preco: 2.5,
    },
    {
      ...
      descricao: "1 maço de aprox. 200g",
      disponivel: true,
      dataCadastro: new Date(2024, 5, 14),
      qtdEstoque: 220,
      preco: 4.99,
    },
    {
      ...
      disponivel: true,
      dataCadastro: new Date(2024, 2, 22),
      qtdEstoque: 350,
      preco: 1.05,
    },
    {
      ...
      disponivel: true,
      dataCadastro: new Date(2024, 2, 23),
      qtdEstoque: 720,
      preco: 1.85,
    },
    {
      ...
      disponivel: true,
      dataCadastro: new Date(2024, 3, 28),
      qtdEstoque: 600,
      preco: 5.39,
    },
    {
      ...
      disponivel: true,
      dataCadastro: new Date(2024, 4, 30),
      qtdEstoque: 95,
      preco: 0.56,
    },
    {
      ...
      disponivel: true,
      dataCadastro: new Date(2024, 5, 29),
      qtdEstoque: 350,
      preco: 1.01,
    },
    {
      ...
      descricao: "1 unidade aprox. 250g",
      disponivel: true,
      dataCadastro: new Date(2024, 5, 11),
      qtdEstoque: 240,
      preco: 11.23,
    },
];
